...
class HEBOSampler(SimpleBaseSampler):  # type: ignore
    def __init__(self, search_space: dict[str, BaseDistribution], rand_sample: int = None) -> None:
        super().__init__(search_space)
        self._hebo = HEBO(self._convert_to_hebo_design_space(search_space), rand_sample=rand_sample)
