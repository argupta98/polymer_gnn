...
def train_xgboost_rank(train_data_path, test_data_path):
    """
        - fit with objective=rank:pairwise
        - predict on test set
        - compare sequences for the top 100 MICs in the test vs. the predictions
            - score based on the union of test_sequences_top_100 U predicted_sequences_top_100
    """
