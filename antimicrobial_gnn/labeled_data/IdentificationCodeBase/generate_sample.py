...
class GenerateSample():
    ...
    def __call__(self, *args, **kwargs):
        ...
        positive_sample = self.generate_all_peptides(grampa_data)
...
if __name__ == "__main__":
    grampa_path = "path_to_origin_file, e.g. ./data/origin_data/grampa.csv"
    negative_file_path = "path_to_negative_sequence_file, e.g. ./data/origin_data/origin_negative.csv"
    generate_example_path = "path_to_save_splited_files"
    mode = "all"
    GenerateSample(grampa_path, negative_file_path, generate_example_path, mode)
